...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'storage_tank.overfill_valve'
        db.add_column('main_storage_tank', 'overfill_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'storage_tank.ten_percent_valve'
        db.add_column('main_storage_tank', 'ten_percent_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'storage_tank.fill_valve'
        db.add_column('main_storage_tank', 'fill_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'storage_tank.no_recoil_valve'
        db.add_column('main_storage_tank', 'no_recoil_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'storage_tank.excess_steam_valve'
        db.add_column('main_storage_tank', 'excess_steam_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'storage_tank.safety_valve'
        db.add_column('main_storage_tank', 'safety_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'storage_tank.check_look_valve'
        db.add_column('main_storage_tank', 'check_look_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'storage_tank.overfill_valve'
        db.delete_column('main_storage_tank', 'overfill_valve')

        # Deleting field 'storage_tank.ten_percent_valve'
        db.delete_column('main_storage_tank', 'ten_percent_valve')

        # Deleting field 'storage_tank.fill_valve'
        db.delete_column('main_storage_tank', 'fill_valve')

        # Deleting field 'storage_tank.no_recoil_valve'
        db.delete_column('main_storage_tank', 'no_recoil_valve')

        # Deleting field 'storage_tank.excess_steam_valve'
        db.delete_column('main_storage_tank', 'excess_steam_valve')

        # Deleting field 'storage_tank.safety_valve'
        db.delete_column('main_storage_tank', 'safety_valve')

        # Deleting field 'storage_tank.check_look_valve'
