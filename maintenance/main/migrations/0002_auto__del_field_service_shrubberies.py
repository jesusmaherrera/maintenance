...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'service.shrubberies'
        db.delete_column('main_service', 'shrubberies')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'service.shrubberies'
        raise RuntimeError("Cannot reverse this migration. 'service.shrubberies' and its values cannot be restored.")
