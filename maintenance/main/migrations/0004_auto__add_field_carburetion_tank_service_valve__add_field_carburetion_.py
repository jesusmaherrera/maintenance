...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'carburetion_tank.service_valve'
        db.add_column('main_carburetion_tank', 'service_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'carburetion_tank.ten_percent_valve'
        db.add_column('main_carburetion_tank', 'ten_percent_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'carburetion_tank.fill_valve'
        db.add_column('main_carburetion_tank', 'fill_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'carburetion_tank.safety_valve'
        db.add_column('main_carburetion_tank', 'safety_valve',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'carburetion_tank.service_valve'
        db.delete_column('main_carburetion_tank', 'service_valve')

        # Deleting field 'carburetion_tank.ten_percent_valve'
        db.delete_column('main_carburetion_tank', 'ten_percent_valve')

        # Deleting field 'carburetion_tank.fill_valve'
        db.delete_column('main_carburetion_tank', 'fill_valve')

        # Deleting field 'carburetion_tank.safety_valve'
